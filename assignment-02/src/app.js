...
async function init() {
    ...
    const x = d3.scaleLinear().domain(d3.extent(data, d => d.sepalwidth)).range([margin.left, width - margin.right]);
    const y = d3.scaleLinear().domain(d3.extent(data, d => d.sepallength)).range([margin.top, height - margin.bottom]);

...
(function () {
  ...
  document.getElementById("name").innerText = "Akshay Patel";document.getElementById("assignment_number").innerText = "5";
  ...
  const plotAuthorkeywordsYear = async () => {
      ...
      const svg = select("#plot-authorkeywords-year")
          .append("svg")
      ...
      const color = sequential(interpolate$1("yellow", "purple")).domain([yearMin, yearMax]);
      ...
      const svgLegend = select("#plot-authorkeywords-year-legend")
          .append("svg")
  ...
  const plotAbstractConference = async () => {
      ...
      const svg = select("#plot-abstract-conference")
          .append("svg")
          .style("background-color", '#e3f2fd')
          .attr("width", width + margin.left + margin.right)
          .attr("height", height + margin.top + margin.bottom)
      ...
      const color = ordinal().domain(uniqueConferences).range(Set3);
